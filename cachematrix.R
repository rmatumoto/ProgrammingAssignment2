## Matrix inversion is usually a costly computation and there may be some benefit to caching the inverse of a matrix rather than computing it repeatedly. The pair of functions below cache the inverse of a matrix. It is assumed that the matrix supplied is always invertible.
